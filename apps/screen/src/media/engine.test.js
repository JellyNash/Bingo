...
describe('WebAudioEngine', () => {
    ...
    describe('volume controls', () => {
        ...
        it('should save volumes to localStorage', () => {
            ...
            expect(localStorage.setItem).toHaveBeenCalledWith('mediaVolumes', expect.stringContaining('0.5'));
        });
        it('should load saved volumes', () => {
            ...
            localStorage.getItem.mockReturnValueOnce(JSON.stringify(savedVolumes));
