...
describe('MediaLoader', () => {
    ...
    beforeEach(() => {
        ...
        mockAudioContext = new global.AudioContext();
    ...
    describe('loadPack', () => {
        it('should load and validate a media pack', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/pack.json', { cache: 'force-cache' });
        ...
        it('should throw error for invalid pack schema', async () => {
            ...
            await expect(loader.loadPack('/media-packs/invalid/pack.json')).rejects.toThrow();
        });
    });
    describe('getNumber', () => {
        beforeEach(async () => {
        ...
        it('should fetch and decode number audio', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/numbers/42.mp3', { cache: 'force-cache' });
    ...
    describe('getSfx', () => {
        ...
        it('should fetch bingo SFX', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/bingo.mp3', { cache: 'force-cache' });
            expect(buffer).toBeDefined();
        });
        it('should fetch stinger SFX', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/stinger.mp3', { cache: 'force-cache' });
            expect(buffer).toBeDefined();
        });
    });
    describe('warmup', () => {
        ...
        it('should preload specified number range', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/numbers/1.mp3', { cache: 'force-cache' });
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/numbers/2.mp3', { cache: 'force-cache' });
            expect(global.fetch).toHaveBeenCalledWith('/media-packs/test/numbers/3.mp3', { cache: 'force-cache' });
        });
    });
